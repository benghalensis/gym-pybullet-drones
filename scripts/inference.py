...
def run(exp=DEFAULT_WT_FOLDER, gui=DEFAULT_GUI, plot=DEFAULT_PLOT, output_folder=DEFAULT_OUTPUT_FOLDER):
    ...
    env_name = exp.split("-")[1]+"-v0"
    OBS = ObservationType.KIN if exp.split("-")[4] == 'kin' else ObservationType.RGB

    # Parse ActionType instance from file name
    action_name = exp.split("-")[5]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp',          default=  DEFAULT_WT_FOLDER,               type=str,            help='The experiment folder written as ./results/save-<env>-<algo>-<obs>-<act>-<time_date>', metavar='')
